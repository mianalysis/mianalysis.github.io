  ...
  return (
    <div className="mx-auto max-w-4xl space-y-16">
      ...
      <section className="space-y-4">
        ...
        <p>
          Output results files can contain multiple, highly configurable sheets. Typically, a
          results file will include a summary sheet with one row per input image, individual object
          sheets with one row per detected object and a couple of record-keeping sheets.{' '}
        </p>
      ...
      <section className="space-y-4">
        <AnchoredHeading type="h2">Summary sheet</AnchoredHeading>
        ...
        <ul>
          <li>
            ...
            <ul>
              ...
              <li>
                ...
                each timepoint in the image, allowing for quick analysis of time-dependent
                processes.
              </li>
              <li>
          ...
          <li>
            ...
            <ul>
              ...
              <li>
                Object count columns can be enabled/disabled using the &quot;Show object
                counts&quot; control in the &quot;Output control&quot; module. Object counts are
                either on or off for all objects.
              </li>
            </ul>
          </li>
      ...
      <section className="space-y-4">
        <AnchoredHeading type="h2">Object sheets</AnchoredHeading>

        <ul>
          <li>
            The individual object sheets include the individual measurements for each detected
            object. Each row of an object results sheet corresponds to a single detected object.
          </li>

          <li>
            The first column is always (&quot;OBJECT_ID&quot;), which is the unique ID number for
            that object in that analysis run.
            <ul>
              <li>
          ...
          <li>
            Metadata and measurement columns can be disabled with the &quot;Ind&quot; controls in
      ...
      <section className="space-y-4">
        <AnchoredHeading type="h2">Record-keeping sheets</AnchoredHeading>

        <ul>
          <li>
            The final two sheets are always record-keeping sheets. These are useful for retaining
            knowledge of how a workflow was run (e.g. plugin version) as well as seeing if any
            errors occurred during execution.
          </li>

          <li>
            The &quot;Configuration&quot; sheet includes some device-specific information such as
            the computer operating system, plugin version and date/time of execution. It also
            includes a full copy of the .mia workflow file used. In the event of the workflow file
            being lost, these rows can be copied into a text file and saved with the .mia extension.
          </li>

    ...
    <div className="mx-auto max-w-4xl space-y-16">
      ...
      <section className="space-y-4">
        ...
        <p>
          ...
          some common problems and solutions. For any problems not covered in the table (or if you
          have concerns something isn&apos;t working correctly), please submit an{' '}
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                ...
                expected; however, to ensure the workflow operates as intended, it&apos;s advisable
                to install the same version of MIA as that used to prepare the workflow. Subsequent
            ...
            <tr>
              ...
              <td>
                If loading a workflow prepared in an older version of MIA, the module in question
                may have been removed. Similarly, if the workflow is from a newer version of MIA,
                this module may not yet have been added. To fix this, install the MIA version
                matching that used to create the workflow.
              </td>
            </tr>
            <tr>
              <td>

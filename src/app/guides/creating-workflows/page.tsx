  ...
  return (
    <div className="mx-auto max-w-4xl space-y-5">
      ...
      <p>
        ...
        . Modules are assembled into a linear sequence that forms the workflow. Each module has its
        own independent set of parameters which can be configured by selecting that module from the
        workflow list. Images and objects created by modules are available to subsequent modules in
        the workflow, as are other items such as measurements, metadata and object relationships.
      </p>
      ...
      <ul>
        <li>
          ...
          . To switch to editing view, select &quot;View {'>'} Switch to editing view&quot; from the
          MIA menu.
          <ul>
            <li>
        ...
        <li>
          ...
          <ul>
            <li>
              ...
              image at this location isn&apos;t automatically loaded into the MIA workspace, instead
              this is done by a variety of image loading modules (see{' '}
      ...
      <ul>
        ...
        <li>
          It&apos;s also possible to allow modules to be disabled from processing view by selecting
      ...
      <li>
        Measurements will also be summarised in a separate &quot;Summary&quot; sheet. This sheet can
        be enabled/disabled in the &quot;Summary sheet&quot; section.
        <ul>
          <li>

  ...
  return (
    <div className="mx-auto max-w-4xl space-y-16">
      ...
      <section className="space-y-4">
        ...
        <p>
          The + button will open a menu listing all available modules sorted by category. Selecting
          a module will insert it into the current workflow (see &quot;Modules in workflow&quot;
          below). If any module is currently selected in the workflow, the new module will be
          inserted immediately after it, otherwise, it will be added to the bottom of the list.
          Similarly, the - button will remove any selected modules (note: multiple modules can be
          selected from the current workflow). The ? and ? buttons can be used to move modules
          around in the workflow. A full list of modules and descriptions can be found in the{' '}
        ...
        <p>
          Existing workflows can be loaded from .mia files using the &quot;Load&quot; button and
          saved with &quot;Save&quot;. If the workflow has been loaded from a .mia file or has been
          saved previously, the &quot;Save&quot; button will overwrite the existing file. To save to
          a new file, please use &quot;File {'>'} Save as...&quot;. A full analysis run can be
          started using the &quot;Run&quot; button. This will run the workflow on the file specified
          in &quot;Input control&quot; and is equivalent to starting an analysis from
          &quot;processing view&quot;. The &quot;Stop&quot; button will terminate any active
          analysis runs.
        </p>
      ...
      <section className="space-y-4">
        ...
        <p>
          ...
          to be evaluated at the top. A pair of fixed modules, &quot;Input control&quot; and
          &quot;Output control&quot;, are always present at the top and bottom of the module list.
          These are concerned with selecting the file(s) to process and exporting results,
          respectively.
        </p>
        ...
        <p>
          ...
          buttons, where a strike-through indicates the module is currently disabled. Most modules
          are also able to display an immediate visual output when they have been evaluated, this
          visualisation can be toggled using the <MiaIcon type="eye_open_black.png" />{' '}
          (visualisation enabled) and <MiaIcon type="eye_closed_black.png" /> (visualisation
          disabled) buttons.
        </p>
        ...
        <p>
          ...
          and dragging them to a new position. Multiple modules can be moved by holding down the
          Ctrl or Shift keyboard buttons or dragging the mouse over multiple module names. Modules
          can be assigned nicknames by right-clicking the name and selecting &quot;Rename&quot;.
        </p>

        <p>
          Primarily for the purpose of testing, workflows can be run manually, one module at a time
          using the evaluation buttons. The <MiaIcon type="arrow_open_black.png" /> button indicates
          a module not yet run, <MiaIcon type="dual_ring.gif" /> a module currently being evaluated
          and <MiaIcon type="arrow_closed_green.png" />a module previously run. Editing a module
          will cause any previously-evaluated modules downstream to reset to the &quot;not yet
          run&quot; state.
        </p>
      ...
      <section className="space-y-4">
        ...
        <p>
          ...
          button, with <MiaIcon type="eye_open_black.png" /> indicating a visible (editable)
        ...
        <p>
          ...
          <MiaIcon type="power_bright_green.png" /> or <MiaIcon type="power_black_strike.png" />{' '}
          icon (depending on state of the module).
        </p>
      ...
      <section className="space-y-4">
        ...
        <p>
          ...
          name, module description or associated parameter descriptions. The module search will
          always look at module names, but module descriptions and associated parameter descriptions
          can be optionally included using the tick boxes.
        </p>

        <p>
          Multiple search terms can be provided (e.g. &quot;overlay outline&quot;), with identified
          modules only needing to match one of the terms. Mandatory search terms can be included
          using quotation marks - all identified modules must include at least one instance of such
          terms.
        </p>
